...
//NON fUNZIONAtest_security($_POST[email], $_POST[nome], $_POST[cognome], $_POST[pwd1],  $_POST[pwd2],  $_POST[eta],  $_POST[genere],  $_POST[peso],  $_POST[altezza]);
/*QUESTO FUNZIONA && $emailStat==1*/
//require 'backend/DataBase/InsertRegistrazione.php';
/*if (!empty($_POST[nome])  && $emailStat==1 ) {
    Inserisci_id(Anagrafica, $_POST[nome], $_POST[cognome], $_POST[eta], $_POST[genere], $_POST[peso], $_POST[altezza], $_POST[pwd1], $_POST[email]);
    header("location: /Coco/frontend/pagine/Login.php");
}*/
...
<html>
	...
	<body>
		<h1>Ricerca MindFulness<?php echo ' o'.$hash; ?><?php echo  $cognome.' stato='.$_POST[eta]?></h1>
	<?php 	echo 'Email: '.$emailStat.'<br>Nome: '.$nomeStat.'<br>Cognome: '.$cognomeStat.'<br> Pass: '.$pwdStat.'<br>Info: '.$infoStato;?>
